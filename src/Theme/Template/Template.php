...
namespace Plott\PlottTheme\Template;
...
class Template
{
    ...
    public function render(array $context = [])
    {
        if ($template = locate_template($path = $this->getRelativePath(), false, false)) {
            ...
            extract(apply_filters("plott/plotttheme/template/context/{$this->getFilename()}", $context));
    ...
    public function getFilename($extension = '.php')
    {
        ...
        return apply_filters('plott/plotttheme/template/filename', "{$this->file}{$extension}");
    }
